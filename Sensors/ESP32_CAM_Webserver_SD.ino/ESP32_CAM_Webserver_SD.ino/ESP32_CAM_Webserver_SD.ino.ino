/*Note:
    * Add your ssid and password in place of "YOUR_SSID" and "YOUR_PASSWORD" field resepectively (Find YOUR_SSID to reach the fields).
    * This sketch requires an SD Card inserted in your ESP Cam SD Card Slot, otherwise your ESP32 will observe boot loop.
*/
